 ...
 * Di sini, setiap Barang menyimpan info lengkap satu item inventaris.
 *
 * @param id       ID unik barang (auto-generate pakai System.currentTimeMillis)
...
data class Barang(
    ...
    val gambarUri: String = ""    // URI gambar dari galeri, disimpan sebagai String
)
